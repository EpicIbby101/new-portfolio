...
const Technologies = () => {
  return (
    <section className="bg-neutral text-neutral-content">
      <div className="max-w-7xl mx-auto px-8 py-16 md:py-28 text-center">
        ...
        <p className="flex space-x-3 justify-center mb-0">
          ...
          >
            {" "}
            <Image
              className="bg-white py-3 px-1 rounded-full mt-0"
        ...
        <br />-<br />
        <h3 className="max-w-xl mx-auto text-3xl opacity-90 leading-relaxed mb-5 md:mb-5 mt-3">
          ⚒️ Tools ⚒️
        </h3>
